        ...
        'options': [
            {
                ...
                'explanation': _("""Difficult for the reader to discern the main idea.  Too brief or too repetitive to establish or maintain a focus.""")  # nopep8
            },
            {
                'order_num': 1, 'points': 3, 'name': 'Fair', 'label': _('Fair'),
                'explanation': _("""Presents a unifying theme or main idea, but may include minor tangents.  Stays somewhat focused on topic and task.""")  # nopep8
            },
            {
                'order_num': 2, 'points': 5, 'name': 'Good', 'label': _('Good'),
                'explanation': _("""Presents a unifying theme or main idea without going off on tangents.  Stays completely focused on topic and task.""")  # nopep8
            },
        ],
    },
    {
        ...
        'options': [
            {
                'order_num': 0, 'points': 0, 'name': 'Poor', 'label': _('Poor'),
                'explanation': _("""Includes little information with few or no details or unrelated details.  Unsuccessful in attempts to explore any facets of the topic.""")  # nopep8
            },
            {
                'order_num': 1, 'points': 1, 'name': 'Fair', 'label': _('Fair'),
                'explanation': _("""Includes little information and few or no details.  Explores only one or two facets of the topic.""")  # nopep8
            },
            {
                'order_num': 2, 'points': 3, 'name': 'Good', 'label': _('Good'),
                'explanation': _("""Includes sufficient information and supporting details. (Details may not be fully developed; ideas may be listed.)  Explores some facets of the topic.""")  # nopep8
            },
            {
                'order_num': 3, 'points': 5, 'name': 'Excellent', 'label': _('Excellent'),
                'explanation': _("""Includes in-depth information and exceptional supporting details that are fully developed.  Explores all facets of the topic.""")  # nopep8
            },
        ],
    },
]
